...
//    public ConsumerLogin(ILogger<ConsumerLogin> logger, ICommandHandler<HandleNewPersonalSignInCommand> commandHandler, IOptions<UserDetailsSettings> userSettings, IOptions<LoginSettings> LoginSettings)
//    {
//        _logger = logger;
...
//    [Function("callback")]
//    public async Task<HttpResponseData> CallBack([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "login/Consumer/callback")] HttpRequestData request)
//    {
